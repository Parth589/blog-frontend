        ...
        <Navbar isHomepage={true} isLoggedIn={true}/>
            <main>
                ...
                from writers on any topic.
                    ...
                    <a href={'listview.html'} className="btn-primary !mx-0 my-5 !px-14 !py-2 !text-lg ">
                        Start Reading
                    </a>
                </section>
                <hr/>
                        ...
                        <ol
                            ...
                            <div className=" ">
                                ...
                                <div className="flex gap-5 text-lightGray text-md">
                                    <span className="w-32 h-7 bg-extremelightGray animate-pulse rounded">  </span>
                                    <span className="w-32 h-7 bg-extremelightGray animate-pulse rounded">  </span>
                                </div>
                            </div>
                            <div className=" ">
                ...
                src="/src/assets/compass.svg" className="w-5"/>Discover More categories</span>
                        ...
                        <div className=" border-extremelightGray border-b-2 pb-20 md:pb-10 ">
                            <ul className=" flex flex-wrap px-7 gap-5 items-center text-lightGray  ">
                                ...
                                <li className="tagg "><a href="search.html?search=Data Science"> Data Science </a></li>
                                <li className="tagg "><a href="search.html?search=Technology"> Technology </a></li>
                                <li className="tagg "><a href="search.html?search=Writing"> Writing </a></li>
                                <li className="tagg "><a href="search.html?search=Relationships"> Relationships </a>
                                </li>
                                <li className="tagg "><a href="search.html?search=Machine Learning"> Machine
                                    Learning </a></li>
                                <li className="tagg "><a href="search.html?search=Productivity"> Productivity </a></li>
                                ...
                                <div className="md:card3 px-5  flex justify-between md:items-center gap-5">
                                    <div className="gap-2 items-center ">
                                        <div className="flex gap-2 items-center">
                                            ...
                                            <span className="w-32 py-3 animate-pulse bg-extremelightGray rounded">
                                </span>
                                        </div>
                                    ...
                                    <div className="w-16 md:w-32 aspect-square bg-extremelightGray animate-pulse">
                                    </div>
                                </div>
